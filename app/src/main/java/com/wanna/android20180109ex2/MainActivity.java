package com.wanna.android20180109ex2;
...
public class MainActivity extends AppCompatActivity {
    String idLove="Love";
    final int NOTIFICTION_ID=123456;
    ...
    public void regChannel()
    {
        ...
        channelLove.setDescription("重要的人");
    ...
    public void click1(View v)
    {
        ...
        builder.setAutoCancel(true);//開啟後刪除通知
        builder.setContentIntent(pi);
        Notification notify = builder.build();
        nm.notify(NOTIFICTION_ID,notify);
    }
    public void click2(View v)
    {
        nm.cancel(NOTIFICTION_ID);
    }
}
